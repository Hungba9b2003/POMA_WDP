...
projectRouter.post("/get-project", ProjectController.getAllProjects);

// tìm dự án
projectRouter.get("/:projectId/get-project", ProjectController.getProjectById);
// chỉnh sửa thông tin dự án chỉ đinh
projectRouter.put("/:projectId/edit", ProjectController.updateProject);
// delete dự án
projectRouter.delete("/:projectId/delete", ProjectController.deleteProject);
// update status dự án
projectRouter.put(
...
projectRouter.get(
  ...
  ProjectController.getInviteMembers
);
